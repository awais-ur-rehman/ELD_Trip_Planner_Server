...
def plan_trip_service(validated_data: dict) -> dict:
    ...
    leg1       = get_route([(c_lat, c_lng),  (p_lat,  p_lng)])
    leg2       = get_route([(p_lat, p_lng),  (dr_lat, dr_lng)])
    full_route = get_route([(c_lat, c_lng),  (p_lat,  p_lng), (dr_lat, dr_lng)])
