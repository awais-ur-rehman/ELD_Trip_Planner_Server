...
class TripRequestAdmin(admin.ModelAdmin):
    list_display    = ("id", "current_location", "pickup_location", "dropoff_location",
                       "current_cycle_used_hours", "created_at")
...
class TripPlanAdmin(admin.ModelAdmin):
    list_display    = ("id", "trip_request", "total_distance_miles",
                       "total_driving_hours", "total_days", "created_at")
    list_filter     = ("total_days", "created_at")
    search_fields   = ("trip_request__current_location", "trip_request__dropoff_location")
    readonly_fields = ("id", "cache_key", "created_at", "updated_at")
    ordering        = ("-created_at",)
    raw_id_fields   = ("trip_request",)
